...
public class ListData extends javax.swing.JFrame {
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        UpdateDelete formUpdateDelete = new UpdateDelete();
        formUpdateDelete.setVisible(true);
    ...
    private void jButtonTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTambahActionPerformed
        ...
        AddData formAddData = new AddData();
        formAddData.setVisible(true);
...
//
//        while (rs.next()) {
//            String[] dataPasien = new String[jmlKolom];
//            for (int i = 0; i < jmlKolom; i++) {
//                dataPasien[i] = rs.getString(i + 1);
//            }
//            dtm.addRow(dataPasien);
//        }
//        return dtm;
//    }
    ...
    while (rs.next()) {
        ...
        for (int i = 0; i < jmlKolom; i++) {
            if (rsmd.getColumnTypeName(i + 1).equalsIgnoreCase("date")) {
                // Format the date value if it's the tanggal_lahir column
                dataPasien[i] = dateFormat.format(rs.getDate(i + 1));
            } else {
                dataPasien[i] = rs.getString(i + 1);
            }
        }
